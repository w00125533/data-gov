...
TABLE_CLASSIFICATION: dict[str, dict] = {
    "ods_ue_signal": {
        ...
        "tags": ["覆盖", "质量", "射频", "标识信息"],
        "tag_codes": ["network.coverage", "network.quality", "equipment.rf", "user.identity"],
    },
    "ods_gnb_alarm": {
        "category_path": ["源数据", "配置"],
        "category_code": "source-data.config",
        "tags": ["BBU", "电源", "机房", "质量"],
        "tag_codes": ["equipment.bbu", "equipment.power", "equipment.machine-room", "network.quality"],
    },
    "dwd_session_qos": {
        "category_path": ["网络", "质量"],
        "category_code": "network.quality",
        "tags": ["速率", "时延", "丢包", "保持", "标识信息"],
        "tag_codes": ["network.rate", "network.latency", "network.packet-loss", "network.retain", "user.identity"],
    },
    "dwd_ho_event": {
        "category_path": ["网络", "移动"],
        "category_code": "network.mobility",
        "tags": ["保持", "接入", "质量", "标识信息"],
        "tag_codes": ["network.retain", "network.access", "network.quality", "user.identity"],
    },
    "dws_cell_hourly": {
        "category_path": ["网络", "覆盖"],
        "category_code": "network.coverage",
        "tags": ["话务", "速率", "保持", "质量"],
        "tag_codes": ["network.traffic", "network.rate", "network.retain", "network.quality"],
    },
    "dws_area_traffic": {
        "category_path": ["网络", "话务"],
        "category_code": "network.traffic",
        "tags": ["容量", "速率", "时延", "活动信息"],
        "tag_codes": ["network.capacity", "network.rate", "network.latency", "user.activity"],
    },
    "ads_cell_profile": {
        "category_path": ["网络", "覆盖"],
        "category_code": "network.coverage",
        "tags": ["容量", "质量", "射频"],
        "tag_codes": ["network.capacity", "network.quality", "equipment.rf"],
    },
    "ads_neighbor_pair": {
        "category_path": ["网络", "移动"],
        "category_code": "network.mobility",
        "tags": ["保持", "质量", "工参"],
        "tag_codes": ["network.retain", "network.quality", "source.engineering"],
    },
    "eval_user_score": {
        "category_path": ["用户", "业务信息"],
        "category_code": "user.service",
        "tags": ["覆盖", "移动", "业务信息", "活动信息"],
        "tag_codes": ["network.coverage", "network.mobility", "user.service", "user.activity"],
    },
    "eval_net_health": {
        "category_path": ["网络", "质量"],
        "category_code": "network.quality",
        "tags": ["覆盖", "话务", "机房", "业务信息"],
        "tag_codes": ["network.coverage", "network.traffic", "equipment.machine-room", "user.service"],
    },
}
